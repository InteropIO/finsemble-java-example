...
public class JavaSwingSimpleExample extends JFrame implements WindowListener {
    /**
     * Logger
     */
     ...
     */
    private JavaSwingSimpleExample(List<String> args) {
    ...
    private void createForm() {
        setTitle("ISP Java Swing Simple Example");
    ...
    private static void launchForm(List<String> args) {
        final JavaSwingSimpleExample example = new JavaSwingSimpleExample(args);
    ...
    private void transmit() {
        ...
        fsbl.getClients().getRouterClient().transmit("runBloombergCommand", args);
        LOGGER.info(String.format("Transmitted %s", args.toString()));
    }
    ...
    public void windowOpened(WindowEvent e) {
        if(launchArgs.size()>0){
            ...
            securityTextField.setEnabled(false);
            tailsTextField.setEnabled(false);
