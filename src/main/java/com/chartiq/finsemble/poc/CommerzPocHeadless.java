...
public class CommerzPocHeadless {
    /**
     * Logger
     */
    private static final Logger LOGGER = Logger.getLogger(CommerzPocHeadless.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            timer.scheduleAtFixedRate(new TimerTask() {
                ...
                @Override
                public void run() {
                    fsbl.getClients().getLogger().log("Commerz POC Headless elapsed event was raised");
                }
            }, 0, 5000);
